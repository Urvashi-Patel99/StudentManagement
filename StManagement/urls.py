"""
URL configuration for StManagement project.
...
name='student_create'),
 path('student/<int:pk>/edit/', views.StudentUpdateView.as_view(),
name='student_edit'),
...
name='student_delete'),
 ...
 path('marks/<int:pk>/delete/', views.MarkDeleteView.as_view(),
name='mark_delete'),
]
